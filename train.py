...
def main():
    ...
    full_train_dataset = TILDataset(
        os.path.join(args.data_path, "processed-train/patches/images"),
        os.path.join(args.data_path, "processed-train/patches/masks", str(args.mask_dir_name))
    )
    ...
    test_dataset = TILDataset(
        os.path.join(args.data_path, "processed-test/patches/images"),
        os.path.join(args.data_path, "processed-test/patches/masks")
    )
